...
- (void)initServer {
    _center = [MRYIPCCenter centerNamed:@"com.vasirakcalgux.volumemixerboost/register"];
...
- (void)register:(NSDictionary *)args {
    ...
    NSString *appNotify = [NSString stringWithFormat:@"com.vasirakcalgux.volumemixerboost/%@~%d/setVolume", bundleID, pid.intValue];
