...
- (void)viewDidLoad{
  ...
  _old_prefs = [NSDictionary dictionaryWithContentsOfFile:@THEOS_PACKAGE_INSTALL_PREFIX"/var/mobile/Library/Preferences/com.vasirakcalgux.volumemixerboost.plist"];
...
-(void)_reset{
  ...
  notify_post("com.vasirakcalgux.volumemixerboost/loadPref");
}
- (void)_migrate{
  for(NSString *oldKey in _old_prefs){
    id value = _old_prefs[oldKey];
    NSString *newKey = [@"com.vasirakcalgux.volumemixerboost_" stringByAppendingString:oldKey];
